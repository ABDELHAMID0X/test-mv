    ...
    <>
      ...
      >
        <div className=" md:absolute relative  top-[20%] left-[10%]  md:w-[1000px]   w-96   items-center     flex md:flex-nowrap flex-wrap md:justify-center  container mx-auto">
          <img className="shadow-2xl md:h-[360px] h-52 mt-14 mb-3   object-cover bg-right-bottom  md:w-[300px]  w-36   rounded-md  md:mx-10 mx-0" src={url+movies.poster_path  } alt="" />
              {/* div hidden in md */}
            <div className="w-full px-3  md:block hidden"> 
            <h1 style={{textShadow: '1px 1px 2px black, 0 0 1em black, 0 0 0.2em black'}}  className="mx-2  md:text-4xl text-2xl ">{ movies.original_title || movies.name}</h1>
          ...
          <p style={{textShadow: '1px 1px 2px black, 0 0 1em black, 0 0 0.2em black'}} className="text-gray-100 md:text-md text-sm drop-shadow-2xl">{movies.overview}</p> 
          ...
          <div>
                    ...
                    >
                      ...
                      Watch Trailer
                        ...
                        <div className='md:hidden block w-full pt-5'>
                              <h1 style={{textShadow: '1px 1px 2px black, 0 0 1em black, 0 0 0.2em black'}}  className=" mb-2 mx-2 text-center text-white md:text-4xl text-2xl ">{ movies.original_title || movies.name}</h1>
                              <div>
                              <p style={{textShadow: '1px 1px 2px black, 0 0 1em black, 0 0 0.2em black'}} className="text-gray-100 md:text-md px-4 text-sm drop-shadow-2xl">{movies.overview}</p>
                              </div>
            ...
            >
              {tvTrailer !== undefined ? (
                ...
                <iframe src={tvTrailer && `https://www.youtube.com/embed/${tvTrailer.key}`}   className=' relative rounded-2xl auto md:w-[974px] w-80   md:h-[548px] h-80 ' title='baka'  frameborder="0"></iframe>
              ) : (
                      ...
                      <div className="flex flex-wrap justify-center ">
                      {
                        cast.slice(0,12).map((ca)=>{
                          return(
                            ...
                            src={ca.profile_path === null ?  'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png' : url+ca.profile_path } alt="" />
                            </div>
              ...
              <div className="section mb-3">
              {
                    similarMovies.length !==0 ?
                      <div>
                        ...
                        <h2 className="text-[#D32444] text-[30px]">Similar Movies</h2>
                        </div>
                ...
                if (movie.poster_path != null) {
                  return (
                      ...
                      <Link to={`/movieInfo/${movie.id}/${media_type}`}>
                        <div className="md:w-64  w-40 mx-2 my-3 ">
                        ...
                        <h1 className="h-10 mb-2">{movie.name || movie.original_title}</h1>
